	...
	<tr>
		...
		<td class="input" width="82%">
			<? if ($t["fieldTypeID"] == 4) {
				...
				echo form_select("tag_single_" . $t["tagTypeID"], "SELECT id, tag FROM contacts_tags WHERE type_id = {$t["tagTypeID"]} AND is_active = 1 ORDER BY precedence", @$v["tagID"], false, "field", false, !$t["isRequired"]);
