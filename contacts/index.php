	...
	if (count($where)) {
		...
		<table class="left" cellspacing="1">
			...
			while ($c = db_fetch($result)) {
				$c['firstname']  = preg_replace('/(' . $needle . ')/i','<span style="background-color:#FFFFBB;padding:1px;"><b>\\0</b></span>', $c['firstname']);
				$c['lastname']  = preg_replace('/(' . $needle . ')/i','<span style="background-color:#FFFFBB;padding:1px;"><b>\\0</b></span>', $c['lastname']);
				$c['organization'] = preg_replace('/(' . $needle . ')/i','<span style="background-color:#FFFFBB;padding:1px;"><b>\\0</b></span>', $c['organization']);
					?>
