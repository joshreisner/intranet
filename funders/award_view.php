...
<table class="left" cellspacing="1">
	...
	if (db_found($activity)) {?>
		...
		<tr class="helptext" bgcolor="<?=$bgcolor?>">
			...
			<td><?=$status?></td>
			<td width="16"><a href="javascript:deleteActivity(<?=$a["activityID"]?>,'<?=$a["activityID"]?>');"><img src="<?=$_josh["write_folder"]?>/images/icons/delete.png" width="16" height="16" border="0"></a></td>
		</tr>
		<? }
	} else {
