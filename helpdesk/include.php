...
function emailITticket($id, $scenario, $admin=false, $debug=false) {
	...
	if (($scenario == "new")			&& ($ticket["departmentID"] == 2)) $admins = array('dsashti@seedco.org', 'jreisner@seedco.org', 'mfriend@seedco.org', 'ichangcimino@seedco.org', 'vvilsaint@seedco.org');
