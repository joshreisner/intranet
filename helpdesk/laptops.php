...
<table class="left" cellspacing="1">
	...
	<tr>
		...
		<td align="center"><nobr><? if ($r["laptopStatusDesc"] == "In") {?>
			...
			<? }?></nobr></td>
		<td width="16"><a href="javascript:deactivateLaptop(<?=$r["laptopID"]?>,'<?=$r["laptopName"]?>');"><img src="<?=$_josh["write_folder"]?>images/icons/delete.png" width="16" height="16" border="0"></a></td>
	</tr>
			<? }
		}
	}?>
