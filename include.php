...
function drawEmail($message) {
	...
	$message = str_replace('<table cellspacing="1" class="left">', '<table cellspacing="1" style="
	...
	$message = str_replace('<td height="150" class="left">', '<td height="150" style="
		padding:3px;
		vertical-align:top;
		width:140px;
		font-size:11px;
	...
	$message = str_replace('<td class="left">', '<td style="
		padding:3px;
		vertical-align:top;
		width:140px;
		font-size:11px;
	...
	$message = str_replace('<td class="text"', '<td style="
		padding:10px;
		line-height:20px;
		vertical-align:top;
		height:140px;
	...
	$message = str_replace('<td class="right text "', '<td style="
		padding:10px;
		line-height:20px;
		vertical-align:top;
		height:80px;
